...
public class CityPickActivity extends CityBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initProvinceDatas();
        show_city_selecter= (Button) findViewById(R.id.show_type_selecter);
...
//        data.setInitSelectText("河北省","石家庄市","平山县");
        ...
        pickerView.setOnPickerClickListener(new OnPickerClickListener() {
            ...
            public void OnPickerClick(PickerData pickerData) {
                ...
                type_text.setText(pickerData.getSelectText());
