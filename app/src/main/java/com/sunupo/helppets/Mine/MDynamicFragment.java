...
import com.sunupo.helppets.user.MineDynamicAdapter;
...
public class MDynamicFragment extends Fragment {
                    ...
                    case 1:
                        if(msg.arg1==1){
                            ...
                            for(int i=0;i<((ArrayList<DynamicBean>)(msg.obj)).size();i++){
                                if(((ArrayList<DynamicBean>)(msg.obj)).get(i).getLoginName().equals(App.loginUserInfo.getLoginName())){
