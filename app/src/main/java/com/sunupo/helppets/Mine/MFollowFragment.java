...
import com.sunupo.helppets.user.MineFollowAdapter;
...
public class MFollowFragment extends Fragment {


    private final String TAG="MFollowFragment";
...
//                                判断这条动态是否被（登录用户点击的）这个用户所关注
        ...
        getDynamicUserFollowUser(App.loginUserInfo.getUserId(),Constants.httpip+"/getDynamicUserFollowUser");//z在请求万关注列表之后，发送message==99，然后在调用sendRequestWithHttpURLConnectionHaveParam
