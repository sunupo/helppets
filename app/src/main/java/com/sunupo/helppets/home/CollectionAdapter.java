...
//          当服务器返回成功代码.equals("1")后，才继续执行
    ...
    public CollectionAdapter(ArrayList<DynamicBean> dynamicBeanArrayList) {
...
//                intent.putExtra("lOGIN_USER_ID",loginUserId);//可以用MyApplication.userinfo.getUserId();替换
                ...
                Log.d("CollectionAdapter", "onClick: "+dynamicBean.getUserId()+"-"+dynamicBean.getDynamicId());
...
//                        break;
    ...
    @Override
    public void onBindViewHolder(@NonNull CollectionAdapter.ViewHolder viewHolder, int i) {
