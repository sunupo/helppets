...
public class HomeItemRecommendFragment extends Fragment {
    ...
    Handler handler;
    CollectionAdapter collectionAdapter,recommendCollectionAdapter;
...
//                            todo 暂时把推荐列表设置为收藏列表
                    ...
                    case 2:
                        ...
                        if(msg.arg1==1){
                            recommendDynamicBeanArrayList.clear();
                            for(int i=0;i<((ArrayList<DynamicBean>)(msg.obj)).size();i++){
                                if(((ArrayList<DynamicBean>)(msg.obj)).get(i).getCollectFlag().equals("已点赞")){
                                    recommendDynamicBeanArrayList.add(   ((ArrayList<DynamicBean>)(msg.obj)).get(i)  );
                                }
                            }
                            recommendCollectionAdapter.notifyDataSetChanged();
...
//        recommendRecyclerView.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.HORIZONTAL));
        recommendRecyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));

        recommendCollectionAdapter=new CollectionAdapter(recommendDynamicBeanArrayList);
