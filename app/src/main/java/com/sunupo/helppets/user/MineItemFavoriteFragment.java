...
public class MineItemFavoriteFragment extends Fragment {


    private final String TAG="MineItemFavoriteFragment";
    ...
    MineFavoriteAdapter favoriteAdapter;
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        favoriteAdapter  =new MineFavoriteAdapter(dynamicBeanArrayList);
        favoriteAdapter.setHttpRequest(new MineFavoriteAdapter.HttpRequest() {
            @Override
