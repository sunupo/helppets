...
//          当服务器返回成功代码.equals("1")后，才继续执行
    ...
    public MineFavoriteAdapter(ArrayList<DynamicBean> dynamicBeanArrayList) {
...
//        }
    ...
    @NonNull
    @Override
    public MineFavoriteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//                        break;
    ...
    @Override
    public void onBindViewHolder(@NonNull MineFavoriteAdapter.ViewHolder viewHolder, int i) {
