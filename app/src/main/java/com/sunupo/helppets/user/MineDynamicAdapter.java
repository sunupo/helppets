...
public class MineDynamicAdapter extends RecyclerView.Adapter<MineDynamicAdapter.ViewHolder>{
...
//          当服务器返回成功代码.equals("1")后，才继续执行
    ...
    public MineDynamicAdapter(ArrayList<DynamicBean> dynamicBeanArrayList) {
...
//        }
    ...
    @NonNull
    @Override
    public MineDynamicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//                        break;
    ...
    @Override
    public void onBindViewHolder(@NonNull MineDynamicAdapter.ViewHolder viewHolder, int i) {
